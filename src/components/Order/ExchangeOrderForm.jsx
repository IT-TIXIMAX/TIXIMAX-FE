...
const formatNumber = (value) => {
  ...
  // Ghép lại (nếu có phần thập phân, dùng dấu phẩy)
...
const formatDecimal = (value) => {
  if (!value && value !== 0) return "";
  return String(value).replace(".", ","); // Decimal dùng dấu phẩy
};

const parseNumber = (value) => {
  if (!value) return "";
  // Xóa dấu chấm ngăn cách hàng nghìn
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleExchangeRateChange}
                        className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 rounded focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all"
                        placeholder="Nhập tỷ giá (VD: 1,67 hoặc 25000,5)"
                        disabled={!isFormEnabled}
                      />
                    </div>
                  </div>
