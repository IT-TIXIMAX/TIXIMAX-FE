...
//                       onChange={(e) => setSearchInput(e.target.value)}
//                       onKeyDown={handleSearchKeyDown}
//                       className="w-full pl-10 pr-10 py-2.5 border-2 border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
//                     />
//                     {searchInput && (
//                       <button
//                         onClick={() => setSearchInput("")}
...
//                   onClick={handleApplySearch}
//                   disabled={loading}
//                   className="px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-semibold transition-all flex items-center gap-2 disabled:opacity-50 whitespace-nowrap shadow-md"
//                 >
//                   <Search size={18} />
//                   Tìm kiếm
//                 </button>
...
//                         <th className="px-3 md:px-4 py-3 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">
//                           #
//                         </th>
//                         <th className="px-3 md:px-4 py-3 text-left text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">
//                           Khách Hàng
...
//                           Liên Hệ
//                         </th>
//                         <th className="px-3 md:px-4 py-3 text-right text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">
//                           Đơn Hàng
//                         </th>
//                         <th className="px-3 md:px-4 py-3 text-right text-xs font-bold text-blue-900 uppercase tracking-wider whitespace-nowrap">
//                           Cân Nặng
...
//                               {actualRank <= 3 && currentPage === 0 ? (
//                                 <div
//                                   className={`w-8 h-8 rounded-full bg-gradient-to-br ${rankColors[index]} flex items-center justify-center shadow-md border border-gray-300`}
//                                 >
//                                   <span className="text-white font-bold text-sm">
//                                     {actualRank}
//                                   </span>
...
//                             <td className="px-3 md:px-4 py-3">
//                               <div className="flex items-center gap-3">
//                                 <div className="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-blue-500 to-blue-700 rounded-full flex items-center justify-center border border-blue-300">
//                                   <span className="text-white font-semibold text-sm">
//                                     {customer?.customerName
//                                       ?.charAt(0)
//                                       ?.toUpperCase() || "?"}
...
//                         onClick={() => handlePageChange(0)}
//                         disabled={currentPage === 0 || loading}
//                         className="px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
//                         type="button"
//                       >
//                         Đầu
//                       </button>
...
//                         onClick={() => handlePageChange(currentPage - 1)}
//                         disabled={currentPage === 0 || loading}
//                         className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
//                         type="button"
//                       >
//                         Trước
//                       </button>
