...
const DashboardManager = () => {
  ...
  const SkeletonCard = () => (
    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 animate-pulse">
      <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100">
        ...
        <div className="h-12 md:h-14 w-32 bg-gray-300 rounded" />
      </div>
    </div>
  );
  ...
  // ✅ class chống bể form
  const cardTitleCls =
    "text-gray-600 text-xs md:text-sm font-semibold uppercase tracking-wide truncate";
  const bigNumberCls =
    "text-3xl md:text-4xl lg:text-5xl font-bold text-blue-600 leading-none break-words tabular-nums";
  const subBigNumberCls =
    "text-3xl md:text-4xl font-bold text-blue-600 leading-none break-words tabular-nums";
  const subValueCls =
    "text-sm md:text-base font-bold text-gray-800 whitespace-nowrap";
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto p-4 md:p-6 lg:p-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 md:p-5">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-1.5 h-8 md:h-9 bg-gradient-to-b from-blue-600 to-blue-700 rounded-full shrink-0" />
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-1 flex-wrap">
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <span className="text-xs md:text-sm font-semibold text-blue-800 whitespace-nowrap">
                        {getFilterLabel()}
                      </span>
                    </div>
                    ...
                    {isConnected && (
                      <div
                        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-green-50 border border-green-200"
        ...
        {/* ✅ Tổng quan */}
        <div className="mb-6 md:mb-8">
          <h3 className="text-xl font-bold text-blue-700 uppercase mb-3">
            Tổng quan
          </h3>
          ...
          {loadingOverview ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
              ...
              <div
                onClick={() => navigate("/manager/dashboard/revenue")}
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[150px]"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Tổng doanh thu</span>
                  ...
                  <div className="flex items-baseline gap-2 min-w-0">
                    ...
                    <span className="text-sm md:text-base text-gray-600 font-medium shrink-0">
                      đ
                    </span>
                  </div>
                </div>
              ...
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Tổng tiền nhập</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
              ...
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Tổng phí ship</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
              ...
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Tổng đơn hàng</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
              ...
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Tổng link đơn</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
                      <LinkIcon className="w-6 h-6 md:w-7 md:h-7 text-white" />
                    </div>
                  </div>
                  <div className="flex items-baseline gap-2 min-w-0">
                    <span className={bigNumberCls}>
              ...
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Khách hàng mới</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
              ...
              <div
                onClick={() => navigate("/manager/dashboard/weight")}
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Khối lượng</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="grid grid-cols-1 gap-2">
                        <div className="flex items-center justify-between gap-3">
                          <span className="text-[11px] md:text-xl text-black font-medium truncate">
                            Khối lượng thực
                          </span>
                          <span className={subValueCls}>
                            {formatNumber(stats.totalWeight)} kg
                          </span>
                        </div>
                        <div className="flex items-center justify-between gap-3">
        ...
        {/* ✅ Chi tiết theo nhóm */}
        <div>
          <h3 className="text-xl font-bold text-blue-600 uppercase mb-3">
            Chi tiết theo từng nhóm
          </h3>
          ...
          {!hasLoadedDetailsOnce && loadingDetails ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              <div
                onClick={() => navigate("/manager/dashboard/weight")}
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[220px]"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-yellow-200 to-yellow-200 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Cân nặng</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
                      <Scale className="w-6 h-6 md:w-7 md:h-7 text-white" />
                    </div>
                  </div>
              ...
              <div
                ...
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[220px]"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-red-200 to-red-200 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Thanh toán</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
              ...
              <div
                ...
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[220px]"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-purple-200 to-purple-200 h-full">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Đơn hàng</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
                      <ShoppingBag className="w-6 h-6 md:w-7 md:h-7 text-white" />
                    </div>
                  </div>
              ...
              {/* ✅ Customers (FIX bể form ở Chi tiết theo nhóm) */}
              <div
                onClick={() => navigate("/manager/dashboard/customer")}
                className="cursor-pointer bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[220px]"
              >
                <div className="p-5 md:p-6 bg-gradient-to-br from-green-200 to-green-300 h-full flex flex-col">
                  <div className="flex items-center justify-between mb-4 min-w-0">
                    <span className={cardTitleCls}>Khách hàng mới</span>
                    <div className="p-2.5 rounded-lg bg-blue-600 shrink-0">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-200">
                    <p className="text-[11px] md:text-xl text-black font-medium truncate">
                      Trong hôm nay
                    </p>
                  </div>
                </div>
