...
const SummaryWeight = () => {
  ...
  /* ===== Skeletons ===== */
  const SkeletonCard = ({ colorClass = "from-gray-50 to-gray-100" }) => (
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-md overflow-hidden animate-pulse">
      <div className="px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="flex items-center gap-2">
          ...
          <div className="h-4 bg-white/30 rounded flex-1 max-w-[150px]" />
        </div>
      </div>
      ...
      <div className="mx-auto p-4 md:p-6 lg:p-8">
        ...
        {isCustom && (
          <div className="mb-6 bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            <div className="flex flex-wrap items-end gap-3">
              ...
              <button
                onClick={() =>
                  fetchSummary({ filterType: "CUSTOM", startDate, endDate })
                }
                disabled={loading}
        ...
        {loading && (
          <>
            <SectionTitle>Tổng quan</SectionTitle>
            <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-6 md:mb-8">
              <SkeletonCard colorClass="from-yellow-50 to-yellow-100" />
              <SkeletonCard colorClass="from-red-50 to-red-100" />
              <SkeletonCard colorClass="from-green-50 to-green-100" />
              <SkeletonCard colorClass="from-blue-50 to-blue-100" />
            </div>
            <SectionTitle>Chi tiết theo từng tuyến</SectionTitle>
            <div className="grid gap-4 md:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        {!loading && (!data || data.length === 0) && (
          <div className="bg-white rounded-xl border border-gray-200 p-12 md:p-16 text-center shadow-sm">
            <Scale className="w-14 h-14 text-gray-300 mx-auto mb-4" />
        ...
        {!loading && data && data.length > 0 && metrics && (
          <>
            ...
            <div className="grid gap-4 md:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mb-6 md:mb-8">
              ...
              {/* Tuyến KL thu cao nhất — XANH DƯƠNG */}
              <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 min-h-[150px]">
                      ...
                      <div className="p-4 bg-gray-50 space-y-2">
                        ...
                        <div className="pt-3 border-t border-gray-200">
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <div className="text-right">
                              <div
                                className={`text-sm font-bold tabular-nums ${difference >= 0 ? "text-green-600" : "text-red-600"}`}
                              >
                                {difference >= 0 ? "+" : ""}
                                {formatKg(difference)} kg
                              </div>
                              <div
                                className={`text-xs font-semibold tabular-nums ${difference >= 0 ? "text-green-500" : "text-red-500"}`}
                              >
                                ({difference >= 0 ? "+" : ""}
                                {percentDiff.toFixed(1)}%)
                              </div>
              ...
              <div className="mt-6 bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    ...
                    {
                      label: "Tổng KL thực",
                      value: `${formatKg(metrics.totalWeight)} kg`,
                      colored: false,
                    },
                    {
                      label: "Tổng KL thu",
                      value: `${formatKg(metrics.totalNetWeight)} kg`,
                      colored: false,
                    },
                    {
                      label: "Chênh lệch",
                      value: `${metrics.totalDifference >= 0 ? "+" : ""}${formatKg(metrics.totalDifference)} kg`,
                      colored: true,
                      positive: metrics.totalDifference >= 0,
                    },
                    ...
                    >
                      ...
                      <div
                        className={`text-xl font-black tabular-nums break-words ${colored ? (positive ? "text-green-600" : "text-red-600") : "text-gray-900"}`}
                      >
                        {value}
                      </div>
                    </div>
