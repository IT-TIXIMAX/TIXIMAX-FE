...
const DeliveryAddressForm = ({ isOpen, onClose, onSuccess }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    phoneNumber: "",
    address: "",
    carrier: "VNPOST", // Changed from isVNpost
    shippingList: [],
  });
  const [shipmentInput, setShipmentInput] = useState("");
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <input
                    ...
                    name="carrier"
                    value="OTHER"
                    checked={formData.carrier === "OTHER"}
                    onChange={handleChange}
                    className="w-5 h-5 text-blue-600 border-gray-300 focus:ring-0 focus:ring-offset-0"
                  />
                  <div className="flex items-center gap-2">
