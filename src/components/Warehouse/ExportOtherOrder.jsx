...
const ExportOtherOrder = () => {
  ...
  const totalWeight = useMemo(() => {
    return shipments.reduce((sum, item) => sum + (Number(item.weight) || 0), 0);
  }, [shipments]);
                ...
                <tbody>
                  {shipments.map((item, index) => (
                    ...
                    >
                      ...
                      {/* ✅ Shipping codes nằm đúng cột “Mã vận đơn” */}
                      <td className="px-4 py-4">
...
export default ExportOtherOrder;
