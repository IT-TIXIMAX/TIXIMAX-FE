...
const MergedPaymentOrder = () => {
  ...
  const calculateTotalAmount = () => {
    return orders.reduce(
      (total, order) => total + (order.finalPriceOrder || 0),
      0
    );
  };
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto p-6">
        ...
        {/* Statistics Cards - LUÔN HIỂN THỊ */}
        ...
        {/* Orders List Section - LUÔN HIỂN THỊ HEADER */}
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          {/* Header with Bulk Actions - LUÔN HIỂN THỊ */}
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {hasSearched ? "Không Có Đơn Hàng" : "Chưa Tìm Kiếm Khách Hàng"}
              </h3>
              <p className="text-gray-500">
                {hasSearched
                  ? "Khách hàng này chưa có đơn hàng nào trong hệ thống"
                  : "Vui lòng tìm kiếm và chọn khách hàng ở trên để xem danh sách đơn hàng"}
              </p>
            </div>
          ) : (
            <div className="p-4">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                            ...
                            <div className="flex items-center text-gray-600">
                              <span className="font-semibold">Tỷ giá:</span>
                              <span className="ml-2">
                                {order.exchangeRate
                      ...
                      <div className="text-right ml-6">
                        ...
                        <div className="text-xl text-gray-900 mt-1 font-medium">
                          Tổng Tiền
                        </div>
                      </div>
                    </div>
